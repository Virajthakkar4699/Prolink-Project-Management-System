                ...
                <div class="panel-body" id="addf">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="entermarks.php" method="post" id="form1">
                            ...
                            <button type="submit" name="emarks" class="btn btn-success" style="margin-right: 20px;"><i class="fa fa-check-circle"></i> Enter Matks</button>
