                        ...
                        <div class="panel-body">
                            ...
                            <div class="input-group">
                               ...
                               <?php
                                        ...
                                        session_start();
                                        $e=$_SESSION["email"];
                                        $query = "select *  from projectgroup where guide_id is null and course_id=(select course_id from committe,faculty where email='$e' and faculty.faculty_id=committe.faculty_id)";
                            ...
                            <button type="submit" name="addguide" class="btn btn-success" style="margin-right: 20px;"><i class="fa fa-check-circle"></i> Allocate Guide</button>
