                ...
                <div class="panel-body" id="addf">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="php/addpanel.php" method="post" id="form1">
                            ...
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <label class="btn btn-primary" type="label">Select Faculty</button>
                                </span> 
                               <select class="form-control" id="panelfaculty1" name="panelfaculty1" required="">
                            ...
                            <div class="input-group">
                               ...
                               <select class="form-control" id="panelfaculty2" name="panelfaculty2" required="">
                            ...
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <label class="btn btn-primary" type="label">Panel Description</button>
                                </span> 
                                <input name="panel_desc" class="form-control" type="text" required="">
                            </div>
                            <br>
                            ...
                            <button type="submit" name="addpanel" class="btn btn-success" style="margin-right: 20px;"><i class="fa fa-check-circle"></i> Add Panel</button>
                ...
                $('#evalution').on('change', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            $("#panelfaculty1").html(result);
                            $("#panelfaculty2").html(result);
...
<?php
    ...
    {
        if($_SESSION["same"]=="yes")
        {
            $_SESSION["same"]="no";
        ?>
    <script>
        
 swal("both panel member can not be same");
