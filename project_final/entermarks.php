...
?>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"> <h3 class="panel-title">Enter Marks of    [<?php echo "   ".$result["name"]; ?>]</h3>
...
?>
                            ...
                            <div class="input-group">
                                ...
                                <input name="om1" class="form-control" type="number" min="0" max="<?php echo $o; ?>" required="" title="number should be positive and under out of marks">
                            </div>
                            <br>
                                <?php  ?>
                            ...
                            <div class="input-group">
                                ...
                                <input name="om2" class="form-control" type="number" min="0" max="<?php echo $o; ?>" required="" title="number should be positive and under out of marks">
                            </div>
                            <br>
                                <?php  ?>
                            ...
                            <div class="input-group">
                                ...
                                <input name="om3" class="form-control" type="number" min="0" max="<?php echo $o; ?>" required="" title="number should be positive and under out of marks">
                            </div>
                            <br>
                                <?php  ?>
                            ...
                            <button type="submit" name="addmarks" class="btn btn-success" style="margin-right: 20px;"><i class="fa fa-check-circle"></i> Submit</button>
