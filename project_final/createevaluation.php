        ...
        <div class="panel">
            <div class="panel-heading">
                ...
                <div class="right">
                    ...
                    <button type="button" id="togglebtn" class="btn-toggle-collapse"><i
                    ...
                    <div class="panel-body">
                        <form action="php/addevalution.php" method="post">
                            ...
                            <div class="input-group">
                                ...
                                <input name="name" class="form-control" type="text" pattern="[a-zA-Z ]{5,}+" required=""
                            ...
                            <div class="input-group">
                                ...
                                <input name="description" class="form-control" type="text" pattern="[a-zA-Z ]+"
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="cr1" required="">
                                    <?php
                            ...
                            <div class="input-group">
                                ...
                                <input name="mr1" class="form-control" type="text" pattern="[0-9]+" required=""
                            ...
                            <div class="input-group">
                                ...
                                <input name="mr2" class="form-control" type="text" pattern="[0-9]+" required=""
                                    title="marks should be positive numebre">
                            </div>
                            <br>
                            ...
                            <div class="input-group">
                                ...
                                <input name="mr3" class="form-control" type="text" pattern="[0-9]+" required=""
                                    title="marks should be positive numebre">
                            </div>
                            <br>
                            ...
                            <button type="submit" name="addevalution" class="btn btn-success"
                                style="margin-right: 20px;"><i class="fa fa-check-circle"></i> Add Evaluation</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form action="php/addevalution.php" method="post">
                                    ...
                                    <td>
                                        <button type="submit" value="edit" name="editeval" class="btn btn-primary"><i
                                                class="">Edit</i></button>
