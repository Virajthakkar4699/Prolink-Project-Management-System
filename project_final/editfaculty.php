        ...
        <div class="panel" id="editframe">
            ...
            <div class="panel-body">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="email" value="<?php echo $_SESSION["facultyemail"]; ?>" required pattern="[a-zA-Z.][a-zA-Z0-9.]+@(gmail.com|utu.ac.in)" title="invalid email">
                </div>
                <br>
