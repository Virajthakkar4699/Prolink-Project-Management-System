                ...
                <div class="panel-body" id="addf">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="php/addcommittee.php" method="post" id="form1">
                            ...
                            <div class="input-group">
                               ...
                               <?php
                                        include 'connection.php';
                                        session_start();
                                        $query = "select faculty_id,faculty_name from faculty where faculty_id not in (select faculty_id from committe)  and faculty_id!=14";
                                        $result = mysqli_query($conn, $query);
                                        while ($row = mysqli_fetch_array($result)) {
                                            ?>
                            ...
                            <div class="input-group">
                               ...
                               <select class="form-control" name="member3" required="">
                               <?php
                                        include 'connection.php';
                                        session_start();
                                        $query = "select faculty_id,faculty_name from faculty where faculty_id not in (select faculty_id from committe) and faculty_id!=14";
                            ...
                            <button type="submit" name="addcommittee" class="btn btn-success" style="margin-right: 20px;"><i class="fa fa-check-circle"></i>Create Committee</button>
